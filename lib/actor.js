...
class Actor extends EventEmitter {
   ...
   */
  constructor(system, parent, definition, id, name, customParameters) {
    super();
  ...
  /**
   * Synchronously checks if this actor is destroying.
   *
   * @returns {Boolean} True if actor is destroying, false otherwise.
   */
  isDestroying() {
    return this.destroying === true;
  }
