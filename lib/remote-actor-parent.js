...
class RemoteActorParent extends ForkedActorParent {
   ...
   * @param {Boolean} pingChild Whether to ping child actor.
   */
  constructor(system, parent, definition, bus, id, name, pingChild) {
    super(system, parent, definition, bus, id, name);
