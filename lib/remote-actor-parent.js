...
class RemoteActorParent extends ForkedActor {
   ...
   */
  constructor(options) {
    var name = options.additionalOptions && options.additionalOptions.name;
    var id = options.system.generateActorId();
  ...
  _createRemoteWorker() {
    return new P((resolve, reject) => {
      var host = this.additionalOptions.host;
      var port = this.additionalOptions.port || defaultListeningPort;
  ...
  /**
   * Enables remote endpoint pinging.
   *
   * @private
   */
  _enableChildPing() {
