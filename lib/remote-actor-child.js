...
class RemoteActorChild extends Actor {
   ...
   */
  constructor(system, actor, definition, parentId) {
    super(system, null, definition, actor.getId(), actor.getName(), actor.getCustomParameters());
  ...
  initialize() {
    return new P((resolve, reject) => {
      ...
      this.server.on('connection', socket => {
        ...
        this.actorPromise =
          P.resolve(new ForkedActorChild(this.system, this.socket, this.wrappedActor, this.definition, this.parentId))
