...
/**
 * Parent stub for ForkedActorChild.
 */
class ForkedActorChildParentStub {
  /**
  ...
  toString() {
    return 'ForkedActorChildParentStub';
  }
}
...
class ForkedActorChild extends ForkedActor {
  ...
  getParent() {
    return new ForkedActorChildParentStub(this, this.parentId);
  }
