...
class LoggerConfiguration extends EventEmitter {
  ...
  static fromObject(obj, log) {
    ...
    log.info('Logger configuration:', configuration.toString());
...
class Logger {
   ...
   */
  static fromConfigurationObject(obj = {}, category = 'Default') {
    return new Logger(undefined, category, LoggerConfiguration.fromObject(obj, new Logger()));
  }
